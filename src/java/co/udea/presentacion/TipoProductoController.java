package co.udea.presentacion;

import co.udea.modelo.TipoProducto;
import co.udea.presentacion.util.JsfUtil;
import co.udea.presentacion.util.PaginationHelper;
import co.udea.modelo.TipoProductoFacade;
...
public class TipoProductoController implements Serializable {
    ...
    @EJB
    private co.udea.modelo.TipoProductoFacade ejbFacade;
